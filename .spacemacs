...
you should place your code here."
  ...
  (defun jml-decreasing () (interactive) (end-of-line) (insert "\n@ decreasing ") (c-indent-line-or-region))
  (defun jml-loop-invariant () (interactive) (end-of-line) (insert "\n@ loop_invariant ") (c-indent-line-or-region))
  (defun jml-full-fun-spec ()
    (interactive)
    (end-of-line)
    (insert "\n/*@") (c-indent-line-or-region)
    (jml-normal-behaviour)
    (jml-precondition)
    (jml-postcondition)
    (jml-assignable)
    (insert "\n  @*/") (c-indent-line-or-region))
  (defun jml-full-loop-inv ()
    (interactive)
    (end-of-line)
    (insert "\n/*@") (c-indent-line-or-region)
    (jml-loop-invariant)
  ...
  (spacemacs/set-leader-keys "ima" 'jml-assignable)
  (spacemacs/set-leader-keys "imi" 'jml-loop-invariant)
  (spacemacs/set-leader-keys "imf" 'jml-full-fun-spec)
  (spacemacs/set-leader-keys "iml" 'jml-full-loop-inv)
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(phpunit phpcbf php-extras php-auto-yasnippets helm-gtags wfnames ggtags geben drupal-mode counsel-gtags counsel swiper ivy company-phpactor phpactor composer php-runtime compat seq company-php ac-php-core xcscope php-mode web-beautify vimrc-mode terminal-here ranger openwith livid-mode skewer-mode simple-httpd json-mode json-snatcher json-reformat js2-refactor multiple-cursors js2-mode js-doc git-gutter-fringe+ git-gutter-fringe fringe-helper git-gutter+ git-gutter diff-hl dactyl-mode company-emacs-eclim eclim coffee-mode boogie-friends web-mode tagedit slim-mode scss-mode sass-mode pug-mode helm-css-scss haml-mode emmet-mode company-web web-completion-data org-projectile org-category-capture org-present org-pomodoro alert log4e gntp org-mime org-download htmlize gnuplot smeargle orgit magit-gitflow magit-popup helm-gitignore gitignore-mode gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link evil-magit magit git-commit with-editor transient company-auctex auctex-latexmk auctex xterm-color shell-pop multi-term flyspell-correct-helm flyspell-correct eshell-z eshell-prompt-extras esh-help auto-dictionary evil-commentary company-quickhelp unfill mwim mmm-mode markdown-toc helm-company helm-c-yasnippet gh-md fuzzy flycheck-rust flycheck-pos-tip flycheck company-statistics company-anaconda company auto-yasnippet yasnippet ac-ispell auto-complete yapfify pyvenv pytest pyenv-mode py-isort pip-requirements live-py-mode hy-mode dash-functional helm-pydoc cython-mode anaconda-mode pythonic toml-mode racer pos-tip cargo markdown-mode rust-mode org-plus-contrib ws-butler winum which-key volatile-highlights vi-tilde-fringe uuidgen use-package toc-org spaceline powerline restart-emacs request rainbow-delimiters popwin persp-mode pcre2el paradox spinner org-bullets open-junk-file neotree move-text macrostep lorem-ipsum linum-relative link-hint indent-guide hydra lv hungry-delete hl-todo highlight-parentheses highlight-numbers parent-mode highlight-indentation helm-themes helm-swoop helm-projectile projectile pkg-info epl helm-mode-manager helm-make helm-flx helm-descbinds helm-ag google-translate golden-ratio flx-ido flx fill-column-indicator fancy-battery eyebrowse expand-region exec-path-from-shell evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-surround evil-search-highlight-persist highlight evil-numbers evil-nerd-commenter evil-mc evil-matchit evil-lisp-state smartparens evil-indent-plus evil-iedit-state iedit evil-exchange evil-escape evil-ediff evil-args evil-anzu anzu evil goto-chg undo-tree eval-sexp-fu elisp-slime-nav dumb-jump f dash s diminish define-word column-enforce-mode clean-aindent-mode bind-map bind-key auto-highlight-symbol auto-compile packed aggressive-indent adaptive-wrap ace-window ace-link ace-jump-helm-line helm avy helm-core popup async))
